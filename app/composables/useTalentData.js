  ...
  const talentsDatabase = {
    '共通天賦': [
      ...
      },
      {
        ...
        chineseName: '謹慎',
        keywords: '〈技能〉',
        content: '你耐心而謹慎，僅在有利時出手。選擇一項技能。當你使用該技能進行檢定，並透過消耗動力購買額外d20時，你可重擲該檢定骰池中的一顆d20。'
      },
      {
      ...
      },
      {
        ...
        chineseName: '臨危不亂',
        keywords: '〈技能〉、命運',
        content: '當情勢艱難時，你能深吸一口氣完成任務。選擇一項技能。當你使用該技能進行檢定時，你可消耗1點命運點，自動通過該檢定，但不會獲得任何動力。'
      },
      {
        englishName: 'Prodigialis Fortuna',
        chineseName: '命運寵兒',
        keywords: '命運',
        content: '掌管命運的神祇喜愛戲弄你，讓你隨命運潮汐浮沉。每當你消耗命運點時，可擲1顆挑戰骰。若結果為效果，立即回復該命運點；若為空白，則立即為遊戲主持人的威脅池產生3點威脅。'
      },
      {
        englishName: 'Skin of Your Teeth',
        chineseName: '死裡逃生',
        keywords: '命運',
        content: '你總能勉強躲過最嚴重的傷害。每場景一次，當你即將承受一個傷勢時，你可以消耗1點命運點以避免承受該傷勢。'
      }
    ],
    ...
    '工程': [
      {
        ...
        chineseName: '爆破專家',
        keywords: '工程',
        content: '你擅長破壞事物。當你攻擊物體、建築或靜止的載具時，可以以工程代替戰鬥，並使用智識加值而非體魄或洞察。當你對此類目標造成傷害時，可以消耗2點動力，將最多等同於你工程等級數量的骰子結果改為效果。'
      },
      {
        englishName: 'Quality Crafting',
        chineseName: '精工製造',
        keywords: '工程',
        content: '你製作的物品、載具與建築品質遠超常人，能承受更多消耗。當你建造物體時，其最大壓力+2，可承受的傷勢數量+1。（更多詳情見第34頁〈物體受損〉。）'
      },
      {
    ...
    '戰鬥': [
      {
        ...
        chineseName: '進擊者',
        keywords: '戰鬥',
        content: '當你進行近戰攻擊時，你可將購買第一顆額外d20的動力消耗降為0。但若如此，本回合直到下個回合開始前，針對你的攻擊難度－1。擁有此天賦的角色不可同時獲得【防禦者】天賦。'
      },
      {
    ...
    '潛匿': [
      {
        ...
        chineseName: '消隱',
        keywords: '潛匿',
        content: '每場景一次，你可用副動作並為遊戲主持人的威脅池產生2點威脅以隱去身形。若如此，在下個回合開始前，你不能成為攻擊目標（帶有區域傷害效果的攻擊除外）。若你處於重度掩蔽中，則不需產生威脅即可使用此天賦。'
      },
      {
